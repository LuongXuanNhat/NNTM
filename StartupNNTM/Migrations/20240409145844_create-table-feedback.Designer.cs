...
namespace StartupNNTM.Migrations
{
    ...
    [Migration("20240409145844_create-table-feedback")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StartupNNTM.Models.Feedback", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("TopicFeedbackId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("TypeFeedbackId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("StartupNNTM.Models.TopicFeedback", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("StartupNNTM.Models.Type", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 4, 9, 21, 58, 44, 73, DateTimeKind.Local).AddTicks(1447),
                            Title = "Chất lượng cao"
                        },
                        new
                        {
                            Id = new Guid("8a8c80fc-f6bb-4631-b682-14a7f33be54f"),
                            CreatedAt = new DateTime(2024, 4, 9, 21, 58, 44, 73, DateTimeKind.Local).AddTicks(1458),
                            Title = "Ngon-bổ-rẻ"
                        });
                });

            modelBuilder.Entity("StartupNNTM.Models.TypeFeedback", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("StartupNNTM.Models.Feedback", b =>
                {
                    b.HasOne("StartupNNTM.Models.TopicFeedback", "TopicFeedback")
                        .WithMany("Feedback")
                        .HasForeignKey("TopicFeedbackId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("StartupNNTM.Models.TypeFeedback", "TypeFeedback")
                        .WithMany("Feedback")
