...
namespace StartupNNTM.Service
{
    public class AccountService : IAccountService
    {
                  ...
                  <div class=""example bg-1"">
                    <section class=""panel"">
                      ...
                      <div class=""panel__content"" style=""font-family: Montserrat; font-size: 14px;"">
                        Xin chào! Chúng tôi đã nhận yêu cầu xác thực tài khoản web <strong>NoViSo</strong> của bạn. Mã dùng một lần của bạn là:
                        <br>
        ...
        private async Task SendPasswordToEmail(string email, string confirmNumber)
        {
            MailContent content = new()
            {
                To = email,
                Subject = "Mật khẩu mới cho tài khoản NoViSo [Nông nghiệp thông minh & thực phẩm sạch]",
                Body = $@"<!DOCTYPE html>
                <html lang=""en"">
                <head>
                  <meta charset=""UTF-8"">
                ...
                <body>
                  <div class=""example bg-1"">
                    <section class=""panel"">
                      ...
                      <div class=""panel__content"" style=""font-family: Montserrat; font-size: 14px;"">
                        Xin chào! Chúng tôi đã nhận yêu cầu quên mật khẩu từ tài khoản web <strong>NoViSo</strong> của bạn. Mật khẩu mới của bạn là:
                        <br>
                        <div style=""font-size: 4em; text-align: center"">
                          {confirmNumber}
                        </div>
        ...
        public async Task<ApiResult<string>> ResetPassword(ResetPassDto resetPass,User user)
        {
